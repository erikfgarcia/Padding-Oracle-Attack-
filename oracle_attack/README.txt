...
The padding_oracle_attack.py is an Python implementation that shows the weaknesses of CBC mode of operation when using PKCS#7 padding

This implemetation uses hex encoding, so the challenge ciphertext has been converted from Base64 to Hex
